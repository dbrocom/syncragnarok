...
#define DEFAULT_ENEMY_TYPE(md) ((md->option.ai_type == 2 || md->option.party_id || md->option.guild_id)?BL_CHAR:(md->option.ai_type == 3)?BL_MOB:(md->special_state.ai?BL_CHAR:BL_PC|BL_HOM|BL_MER))
